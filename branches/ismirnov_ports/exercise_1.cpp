...
class C
{
        ...
        // check if data <= DATA_LIMIT, if NOT then programm stops
        void checkData ( int data,  int cycle);
...
public:
        ...
        /* "Clock" C object, i.e. execute all actions
         * that it performs for a cycle: read ports,
         * check data, stop programm when necessary.
         */
        void clock ( int cycle);
};
...
void C::checkData ( int data, int cycle)
{
        cout << "\t verifying data in object C\n";
        ...
        cout << "\t data limit wasn't exceeded by data\n";
}
