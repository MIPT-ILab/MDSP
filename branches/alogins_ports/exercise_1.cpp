...
class C
{
    /* "C" checks, if data limit is exceeded
     * and sends signal to "Stop" port if it is.
     */
    ReadPort<int>* _from_B;
...
{       
        ...
        cout << "\t\tProcess data: new value = " 
                        << data << "\n" << "\t\t\tsend it to A\n"
                        << "\t\t\tsend request for checking data to C\n";
...
{       
        cout << "\t\tProcess data: checking data " 
                        << data << "\n";
