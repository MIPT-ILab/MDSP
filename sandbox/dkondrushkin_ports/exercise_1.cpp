...
#define PORT_FANOUT 1	// it will be increased by 1 for writing port to_A_and_C
#define PORT_BW 1
...
A::A()
{
        ...
        _from_B = new ReadPort<int> ( "B_to_A_and_C", PORT_LATENCY);
